...
export default function Dolar({navigation}) {
...
const handleClear = () => {
  ...
  return (
   <Container>
    <HeaderText>
      <Title>Conversão para Dolar</Title>
    </HeaderText>
    <InputContainer>
        <Input
        ref={inputRef}
      ...
      <ButtonContainer>
      <Button color= '#30ad23' onPress={converteRealDolar}>
    ...
    <ButtonContainer>
  <Button color="#2980b9" onPress={()=>navigation.navigate('Euro')}>
    <Text style={{fontSize: 22, color: 'white'}}>Converter para Euro</Text>
  </Button>
</ButtonContainer>
<ButtonContainer>
